...
import { policiesList } from './mocks/fetch_policies'
...
if (process.env.REACT_APP_ENABLE_MOCK) {
	...
	mock
		.onGet('/ecosystems').reply(200, ecosystemsExampleData)
		.onGet('/ecosystems/123ds-1231qwsdfsd-12eqadfgs/objects').reply(200, list)
    .onGet('/ecosystems/123ds-1231qwsdfsd-12eqadfgs/policies').reply(200, policiesList)
		.onPost('/ecosystems/123ds-1231qwsdfsd-12eqadfgs/objects').reply(201, newOne)
		.onPut('/ecosystems/123ds-1231qwsdfsd-12eqadfgs/objects/2ewsvw234ewrdsf').reply(400)
		.onAny().reply(400)
}
